...
def display_result(player1, player2, num_guesses, sec_num):
    """
    Display the result of the game.
    """
    print(f"Secret number was: {sec_num}")
    if num_guesses == 1:
        print(f"{player1} guessed the secret number in {num_guesses} guess!")
    else:
        print(f"{player2} guessed the secret number in {num_guesses} guesses!")
