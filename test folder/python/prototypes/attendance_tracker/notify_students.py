...
staff_emails = {
    "ATC": "danny@example.com",
    "AAT": "vikram@example.com",
    "EEG": "ajith@example.com",
    "FPC": "vijay@example.com"
}
...
for row in sheet.iter_rows(min_row=2, max_row=sheet.max_row, values_only=True):
    ...
    # Unpack the columns
    try:
        roll_number, name, atc_marks, aat_marks, eeg_marks, fpc_marks, student_email = row[:7]
    except ValueError:
    ...
    subjects = {"ATC": atc_marks, "AAT": aat_marks, "EEG": eeg_marks, "FPC": fpc_marks}
